...
"""
this file can read the solution of correct_model.cvc,message_dc_model.cvc and find_dc_model.cvc to obtain differential 
characteristic
"""

if __name__ == '__main__':
    data = open("res2_dc_solution_90.out", "r").read()
    get_dc(data, 40, "x")
    get_dc(data, 40, "y")
    get_dc(data, 40, "w")
