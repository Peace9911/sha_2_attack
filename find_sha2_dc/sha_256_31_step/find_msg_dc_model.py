...
class FunctionModel:
    ...
    def message_expand(self, in_var_v_w0, in_var_d_w0, in_var_v_w1, in_var_d_w1, in_var_v_w2, in_var_d_w2, in_var_v_w3,
        ...
        self.expand_model(in_var_v_b4, in_var_d_b4, in_var_v_c3, in_var_d_c3, in_var_v_w4, in_var_d_w4, 1)
    ...
    def solver(self):
        ...
        for obj_val in range(50, -1, -1):
            ...
            if "Valid.\n" != R.decode():
                file = open("res2_dc_message_" + "_" + str(self.__bounds_rounds) + "_" + str(obj_val) + ".out", "w")
                file.write(R.decode())
                file.close()
