...
class sha2:
    def __init__(self, rounds, message):
        ...
        self.__assign = []  # save assign value constrains
    ...
    def create_constraints(self, X, propagation_trail):
        ...
        constrains = 'ASSERT ' + '&'.join(fun) + '= 0bin1' + ';\n'
        return constrains
    ...
    def assign_value_e(self):
        x = ["===u============================",
             ...
             "0111============================",
             "1000=========10======1===1==1===",
             "unnn1=0=00=0=00=01=1=100=0110=1=",
             "100n0n110111=nu00011un101n11n=00",
             "0101u0n=1n0n010=u0=10nun=1u01=n1",
             "=10001000010001=0===0110=10=1=0=",
             "=unn00000001100011=00011==0=101=",
             "11100nuuuuuuuuu1u=01un000001n001",
             "=111=0000000000=0=1=001111111=1=",
             "11001101101000000101nuuuuuuuu001",
             ...
             "011100un1u001unnnn11000000101111",
             "=110=111=0===11101=======1==1===",
    ...
    def main(self):
        ...
        file_write.close()
        print("start solver")
        stp_parameters = ["stp", "varification_model.cvc", "--cryptominisat", "--threads", "16"]
        R = subprocess.check_output(stp_parameters)
        print(R.decode())
        open("res2_varification_solution.out", "w").write(R.decode())
