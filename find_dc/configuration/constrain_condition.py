modular_addition_constrain = ['1---1-01--', '-0--011---', '1--01----0', '-1-0-1-1--', '1-1--0---0', '--010-1---',
...
expand_model_constrain_1 = ['----10--', '-0-0---1', '-0-1-0--', '----0101', '--01--1-', '0101---0', '01--1--0',
                            '01----1-', '--011--0', '------10', '----1-1-', '1---01-0', '-1-1-1--', '--1-01-0',
                            '10------', '-0-0-1--', '1-----01', '1-1---0-', '-1-0-0--', '--10----', '--1---01']

expand_model_constrain_2 = ['--10----', '01----1-', '1-01--0-', '--1-01-0', '1---1-0-', '1-----01', '----10--',
