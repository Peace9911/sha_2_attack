...
def sha2_value(block_size, fna0, fna1, step):
    ...
    eqn__constraints.append(
        boolean_value(block_size, right_shift(e[3], 14), right_shift(e[3], 18), right_shift(e[3], 41),
                      in_var_b[0], "XOR"))
    ...
    # computer ai
    eqn__constraints.append(
        boolean_value(block_size, right_shift(a[3], 28), right_shift(a[3], 34), right_shift(a[3], 39),
                      in_var_b[6], "XOR"))
